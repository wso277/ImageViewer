...
- (void)addImgurAccount {
    [[NetworkWrapper sharedInstanceWithSchema:IMGUR_SCHEMA] presentOauthControllerInViewController:self];
}
                         
- (IBAction)addButtonPressed:(id)sender {
    NSLog(@"Add button pressed");
    
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Choose source" message:@"" preferredStyle:UIAlertControllerStyleActionSheet];
    
    [alert addAction:[UIAlertAction actionWithTitle:@"Imgur" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSLog(@"Add imgur");
        [self addImgurAccount];
    }]];
